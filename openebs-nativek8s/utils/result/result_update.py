...
default_path = 'openebs-nativek8s/pipelines/OpenEBS-base/stages/{}'.format(stage)
job_dir = ""
...
job_dir_path = "openebs-nativek8s/pipelines/OpenEBS-base/stages/{}/{}".format(stage,job_dir)
...
# readme.md file path
file_path = "openebs-nativek8s/pipelines/OpenEBS-base/stages/{}/{}/README.md".format(stage, job_dir)
print(file_path)
