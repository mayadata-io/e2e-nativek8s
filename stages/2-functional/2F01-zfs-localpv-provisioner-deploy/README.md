### 2F01-zfs-localpv-provisioner-deploy
...
- To get the detailed README for this test [click here](https://github.com/openebs/e2e-tests/experiments/zfs-localpv/functional/zfs-localpv-provisioner).
